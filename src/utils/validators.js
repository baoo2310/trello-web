...
export const singleFileValidator = (file) => {
    ...
    if(file.size > LIMIT_COMMON_FILE_SIZE) return 'Maximum file size exceeded. (10MB)';
    if(!ALLOW_COMMON_FILE_TYPES.includes(file.type)) return 'File type is invalid. Only accpt jpg, jpeg, png.';
    return null;
}